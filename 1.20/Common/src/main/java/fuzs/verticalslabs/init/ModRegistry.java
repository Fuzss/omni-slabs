...
public class ModRegistry {
    ...
    public static final CapabilityKey<HitVectorCapability> HIT_VECTOR_CAPABILITY = CAPABILITY.registerPlayerCapability("hit_vector", HitVectorCapability.class, HitVectorCapability::new, PlayerRespawnCopyStrategy.NEVER);
